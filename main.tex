...
\begin{figure}
    \centering
    \includegraphics[width=0.3\linewidth]{Maulana_Abul_Kalam_Azad_University_of_Technology_Logo.PNG}
\end{figure}
...
[remember picture, overlay] \draw[line width = 2pt] ($(current page.north west) + (0.5in, -0.5in)$) rectangle ($(current page.south east) + (-0.5in, 0.5in)$);
\end{tikzpicture}
\title{Lab Entry By\\[0.5cm] \large Jaya Shree Biswas\\[0.5cm]
    \begin{figure}
    \centering
...
\begin{center}
\title{Lab Entry By\\[0.5cm] \large Soumyadeep Goswani\\[0.5cm]
...
\begin{figure}[h!]
    \centering
            \includegraphics[width=0.5\linewidth]{input1.jpg}
            \caption{JAVA CODE}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{output2.jpg}
...
\title{Lab Entry By\\[0.5cm] \large Suraj Maharaj\\[0.5cm]
...
\author{\centering \Large \textbf{Lab Entry By} \\[0.5cm] \large Koyena Brahma}
...
\author{\centering \Large \textbf{Lab Entry By} \\[0.5cm] \large \textbf{Debapriya Dutta}}
\begin{document}
